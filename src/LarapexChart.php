<?php namespace ismarel\LarapexCharts;
...
class LarapexChart
{
    ...
    public function setMode(string $mode): LarapexChart
    {
        $this->mode = $mode;
        return $this;
    }
    ...
    public function toJson()
    {
        $options = [
            ...
            'seriesM' => json_decode($this->datasetM()),
